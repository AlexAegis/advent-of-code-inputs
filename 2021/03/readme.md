...
> [TypeScript](/solutions/typescript/2021/03/src/p1.ts)
...
epsilon rate, then multiply them together. **What is the power** **consumption
...
> [TypeScript](/solutions/typescript/2021/03/src/p2.ts)
